...
- `components/utils/` folder contains JS modules with functions and variables needed by the components to perform specific tasks:
  ...
  - `fretboardMode.js`: functions for creating and handling the guitar fretboard data model
...
- it prioritizes chords with

more distinct pitch classes and, in case these are always equal, it puts first the chord with the highest overall number of notes;
